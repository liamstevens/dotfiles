...
POWERLEVEL10K_LEFT_PROMPT_ELEMENTS=(os_icon context battery dir vcs)
POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(status time dir_writable ip custom_wifi_signal ram load background_jobs)

POWERLEVEL10K_SHORTEN_DIR_LENGTH=1

POWERLEVEL10K_TIME_FORMAT="%D{\uf017 %H:%M \uf073 %d/%m/%y}"
POWERLEVEL10K_TIME_BACKGROUND='white'
POWERLEVEL10K_RAM_BACKGROUND='yellow'
POWERLEVEL10K_LOAD_CRITICAL_BACKGROUND="white"
POWERLEVEL10K_LOAD_WARNING_BACKGROUND="white"
POWERLEVEL10K_LOAD_NORMAL_BACKGROUND="white"
POWERLEVEL10K_LOAD_CRITICAL_FOREGROUND="red"
POWERLEVEL10K_LOAD_WARNING_FOREGROUND="yellow"
POWERLEVEL10K_LOAD_NORMAL_FOREGROUND="black"
POWERLEVEL10K_LOAD_CRITICAL_VISUAL_IDENTIFIER_COLOR="red"
POWERLEVEL10K_LOAD_WARNING_VISUAL_IDENTIFIER_COLOR="yellow"
